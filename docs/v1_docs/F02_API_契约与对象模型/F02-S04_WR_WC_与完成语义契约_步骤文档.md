...
synced_at: "2026-07-21T00:16:28+08:00"
generated_by: "ugdr-sync-docs-to-md"
generated_body_sha256: "70af4418851445d7ea7fa7f59d99183546ee27f9d1924a39c405c5693634dfc7"
---
...
| `retry_cnt` | `uint8_t` | `UGDR_QP_RETRY_CNT = 1U << 12U` | RC transport retry 编码。 |
| `rnr_retry` | `uint8_t` | `UGDR_QP_RNR_RETRY = 1U << 13U` | RNR retry 编码；值 7 表示无限重试。 |
